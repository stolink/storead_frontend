...
export const RelationshipLegend = memo(function RelationshipLegend({
  ...
  return (
    <div className="flex flex-col gap-3 p-4 bg-paper/80 backdrop-blur-md border border-mocha-100/50 rounded-xl shadow-lg transition-all hover:shadow-xl animate-in fade-in duration-500">
      <div className="flex items-center gap-2 mb-1">
        <Layers className="w-3.5 h-3.5 text-mocha-400" />
        <Label className="text-xs font-bold text-mocha-500 uppercase tracking-wider">
          관계 유형 (범례)
        </Label>
      </div>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? "bg-white border-mocha-200 text-mocha-700 shadow-sm"
                  : "bg-mocha-50/50 text-mocha-400 border-transparent hover:bg-white",
              )}
              style={{
