...
import { usePublicWork, usePublicChapters } from '@/hooks/useDiscovery';
import { useAddToLibrary, useRemoveFromLibrary, useIsInLibrary } from '@/hooks/useLibrary';
...
export const WorkDetailPage = () => {
    ...
    const { data: chapters, isLoading: chaptersLoading } = usePublicChapters(
        id || ''
    );
                    ...
                    <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-zinc-600 dark:text-zinc-400 mb-4">
                                ...
                                <div className="flex items-center gap-1">
                                    <Star className="h-4 w-4 text-yellow-400 fill-yellow-400" />
                                    <span className="font-semibold">{(avgRating / 2).toFixed(1)}</span>
                            ...
                            <div className="flex gap-3">
                                ...
                                {isAuthenticated && (
                                    ...
                                    >
                                        <Heart
                                            className={`h-5 w-5 mr-2 ${isInLibrary ? 'fill-current text-red-500' : ''
                                                }`}
                                        />
