...
const LibraryCard = ({
    ...
    const avgRating = work.ratingCount > 0 ? work.ratingSum / work.ratingCount / 2 : 0;
...
export const LibraryPage = () => {
    ...
    if (!isAuthenticated) {
        return (
            <div className={`min-h-screen flex flex-col items-center justify-center ${backgroundThemeClasses[theme]}`}>
