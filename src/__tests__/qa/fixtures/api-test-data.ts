...
export const discoveryTests: ApiTestCase[] = [
    ...
    // Error Case
    { id: "TC-DISC-ERR-001", description: "작품 검색 결과 없음", method: "GET", url: "/discovery/search", requestUrl: "/discovery/search?keyword=unknown", mockResponse: { body: { data: { content: [] } } }, verify: (j) => expect(j.data.content).toHaveLength(0) }
];
