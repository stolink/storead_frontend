...
export function NetworkDetailPanelD3({
    ...
    return (
        <div className="absolute right-4 top-4 bottom-4 w-80 z-20 bg-white border border-cloud-200 rounded-2xl overflow-hidden flex flex-col animate-in fade-in slide-in-from-right-4 duration-500 shadow-paper-floating">
            <div className="p-6 bg-white border-b border-cloud-100">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="w-20 h-20 rounded-2xl bg-stone-50 border border-stone-200 flex items-center justify-center text-3xl shadow-sm overflow-hidden text-stone-400">
            ...
            <div className="px-5 py-4 border-b border-stone-50">
                <div className="grid grid-cols-2 gap-3">
                    <div className="p-4 bg-stone-50 border border-stone-100 rounded-xl group hover:border-mocha-200 transition-all">
            ...
            <div className="px-5 py-5 border-b border-stone-50 space-y-5 bg-gradient-to-b from-stone-50/30 to-white">
                {(() => {
                    ...
                    } else if (corePersonality && Array.isArray(corePersonality.coreTraits)) {
                    ...
                    return (
                        <>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative p-3 rounded-xl border border-stone-100 bg-white shadow-sm overflow-hidden">
                                    ...
                                    <div className="mt-2 h-1 w-full bg-stone-50 rounded-full overflow-hidden relative z-10">
                                        <motion.div
                                            initial={{ width: 0 }}
                                    ...
                                    {traits.length > 0 ? (
                                        traits.slice(0, 6).map((trait: string, i: number) => (
                                            <motion.span
                                                ...
                                                className="px-2.5 py-1 bg-white border border-stone-200 rounded-lg text-[11px] text-stone-600 font-medium shadow-sm active:shadow-none transition-shadow"
                                            >
                                                {trait}
                                            </motion.span>
                                        ))
            ...
            <ScrollArea className="flex-1">
                <div className="p-5">
                    <h4 className="text-xs font-bold text-stone-900 uppercase tracking-wider mb-4 flex items-center gap-2">
                    ...
                    {connectedLinks.length > 0 ? (
                        <ul className="space-y-2">
                            {connectedLinks.map((link, idx) => {
                                ...
                                return (
                                    <li
                                        key={link.id || idx}
                                        className="flex items-center gap-3 p-3 bg-white border border-stone-100 rounded-xl hover:shadow-md hover:border-mocha-200 cursor-pointer group transition-all"
                                        style={{ animationDelay: `${idx * 50}ms` }}
                                    >
                                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-stone-100 to-white flex items-center justify-center text-lg border border-stone-100 shadow-sm overflow-hidden group-hover:shadow-md transition-shadow">
                                            {otherChar?.imageUrl ? (
                                                <img
                        ...
                        <div className="py-8 text-center border border-dashed border-stone-200 rounded-xl">
                            <Users className="h-8 w-8 text-stone-200 mx-auto mb-2" />
            ...
            {/* Footer */}
            <div className="p-5 bg-white border-t border-stone-100 pb-8">
                <Button
                    variant="default"
