...
export const RelationshipCommentItem = memo(({
    ...
    // 대댓글 데이터 페칭 (부모인 경우에만)
    const { data: remoteReplies, isLoading: isLoadingReplies } = useReplies(comment.id, (comment.replyCount || 0) > 0);
    ...
    return (
        <div className="space-y-4">
            ...
            >
                ...
                <Avatar className={cn("shrink-0 border-2 border-white shadow-paper transform transition-transform group-hover:scale-105", isReply ? "h-8 w-8" : "h-10 w-10")}>
                ...
                <div className="flex-1 space-y-2 min-w-0">
                    ...
                    <div className="flex items-center gap-6 px-1">
                        ...
                        {!isReply && (
                            <button
                                onClick={() => onSetReplyTo({ id: comment.id, name: comment.author?.nickname || "익명" })}
